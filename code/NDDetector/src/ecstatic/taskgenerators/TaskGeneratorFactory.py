...
from src.ecstatic.taskgenerators.OptTaskGenerator import OptTaskGenerator
...
from src.ecstatic.taskgenerators.SOOTUPTaskGenerator import SOOTUPTaskGenerator
...
class TaskGeneratorFactory():
    ...
    def get_task_generator_for_option(self,option:str,benchmark:str) -> AbstractTaskToolGenerator:
        ...
        if(option.strip().lower() == "flowdroid"):
            ...
            return DOOPTaskGenerator();
        elif(option.strip().lower() == "opt"):
            return OptTaskGenerator();
        ...
        elif(option.strip().lower() == "sootup"):
            return SOOTUPTaskGenerator();
