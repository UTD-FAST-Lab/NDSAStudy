...
class WalaJSTaskGenerator(AbstractTaskToolGenerator):
    def __init__(self):
        a=""
    def read_config_and_generate_jobs(self,benchmark_records) -> DetectionCampaign:

        configfile="/ECSTATIC/src/resources/configurations/WALAJS-2way-covered.csv"
        job_list = []
        header = []
        lines = [];
