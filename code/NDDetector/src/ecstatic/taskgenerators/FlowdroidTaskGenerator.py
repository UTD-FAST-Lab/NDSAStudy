...
class FlowdroidTaskGenerator(AbstractTaskToolGenerator):
    def __init__(self):
        a="";
    def read_config_and_generate_jobs(self,benchmark_records):

        configfile="/ECSTATIC/src/resources/configurations/Flowdroid-2way-covered.csv"
        #read from flowdroid config, same place everytime since we in docker container
        #op1,opt2,opt3,opt4,opt5,opt6
        #S1,s1,s1,s1,s1,s1
        #...
        #Sn,Sn,...
        job_list = []
