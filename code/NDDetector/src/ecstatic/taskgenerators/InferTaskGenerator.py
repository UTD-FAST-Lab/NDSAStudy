...
class InferTaskGenerator(AbstractTaskToolGenerator):
    def __init__(self, benchmark):
        self.benchmark=benchmark
    def read_config_and_generate_jobs(self,benchmark_records):
        configfile="/ECSTATIC/src/resources/configurations/Infer-2way-covered.csv"
        job_list = []
        ...
        for configline in lines:
            ...
            for x in configline:
                ...
                i+=1
            job_list.append(DetectionJob(tool_config, BenchmarkRecord(self.benchmark)))
