...
def move_nd_files(origin, nondex, file, tool, benchmark):
...
def checkResults(origin, nondex, o_not_nondeterminism, task, tool, benchmark):
    ...
    for file in o_not_nondeterminism:
        ...
        if not os.path.exists(file_s):
            ...
            error = True
            nondeterminism = True
            move_nd_files(origin, nondex, file, tool, benchmark)
        else:
...
def main():
    ...
    checkResults(origin, nondex, o_not_nondeterminism, task, tool, benchmark)
