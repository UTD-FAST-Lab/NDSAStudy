...
def try_resolve_path(path: str, root: str = "/") -> str:
    ...
    #I am just gonna loop through benchmarks, trying paths.
    benchmark_roots = os.listdir("/benchmarks")
    for x in benchmark_roots:
        curpath ="/benchmarks/"+x+"/"+path
        if(os.path.exists(curpath)):
            return curpath

    #this loop barely seems to work
